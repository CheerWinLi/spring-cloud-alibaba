...
public class FeignClientToDubboProviderBeanPostProcessor implements BeanDefinitionRegistryPostProcessor, EnvironmentAware,
    ...
    private void registerServiceBean(BeanDefinitionHolder beanDefinitionHolder, BeanDefinitionRegistry registry,
        ...
        DubboService service = findAnnotation(beanClass, DubboService.class);
        if (null == service) {
        ...
        if (registry.containsBeanDefinition(beanName)) { // check duplicated candidate bean
    ...
    private String generateServiceBeanName(DubboService service, Class<?> interfaceClass, String annotatedServiceBeanName) {
    ...
    private Class<?> resolveServiceInterfaceClass(Class<?> annotatedServiceBeanClass, DubboService service) {
    ...
    private AbstractBeanDefinition buildServiceBeanDefinition(DubboService service, Class<?> interfaceClass,
